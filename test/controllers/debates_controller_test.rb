...
class DebatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create debate" do
    assert_difference('Debate.count') do
      post debates_url, params: { debate: { description: @debate.description, image: @debate.image, topic: @debate.topic } }
    end
  ...
  test "should update debate" do
    patch debate_url(@debate), params: { debate: { description: @debate.description, image: @debate.image, topic: @debate.topic } }
